...
## Modulos
-[Modulo de Reportes y Estadistica](ProyectoRestaurante_templateHome/estadisticas)
...
-[models](ProyectoRestaurante_templateHome/estadisticas/models.py)

-[Modulo de Facturacion y Pagos](ProyectoRestaurante_templateHome/facturacion)
...
-[models](ProyectoRestaurante_templateHome/facturacion/models.py)

-[Modulo de Inventario](ProyectoRestaurante_templateHome/inventario)
...
[models](ProyectoRestaurante_templateHome/inventario/models.py)

-[Modulos de Menús y Productos](ProyectoRestaurante_templateHome/menu)
...
-[models](ProyectoRestaurante_templateHome/menu/models.py)

-[Modulos de Pedidos](ProyectoRestaurante_templateHome/mesas)
...
-[Modulo de Mesas y reservaciones](ProyectoRestaurante_templateHome/pedidos)
...
-[models](ProyectoRestaurante_templateHome/mesas/models.py)
## Diagramas de Clases 
